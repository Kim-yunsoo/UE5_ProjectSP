...
public:
	static void Init()
	{
		...
		GPacketHandler[PKT_C_GAME_OVER] = [](PacketSessionRef& session, BYTE* buffer, int32 len) { return HandlePacket<Protocol::C_GAME_OVER>(Handle_C_GAME_OVER, session, buffer, len); };
